...
export const progressVariants = {
  ...
  variant: {
    determinate: 'bg-blue-300 dark:bg-blue-800 *:bg-blue-500 dark:*:bg-blue-600',
    success: 'bg-green-300 dark:bg-green-800 *:bg-green-500 dark:*:bg-green-600',
    warning: 'bg-yellow-200 dark:bg-yellow-700 *:bg-yellow-400 dark:*:bg-yellow-500',
    error: 'bg-red-300 dark:bg-red-800 *:bg-red-500 dark:*:bg-red-600',
    accent: 'bg-purple-300 dark:bg-purple-800 *:bg-purple-500 dark:*:bg-purple-600',
